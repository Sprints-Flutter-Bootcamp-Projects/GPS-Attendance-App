          ...
          data: Theme.of(context).brightness == Brightness.dark
              ? ThemeData.dark().copyWith(
                  colorScheme: const ColorScheme.dark(
                    primary: TrackSyncColors.highlightDarkest, // Header background color
                  ...
                  textButtonTheme: TextButtonThemeData(
                    style: TextButton.styleFrom(
                      foregroundColor: TrackSyncColors.lightLightest, // Button text color
                      backgroundColor: TrackSyncColors.highlightDarkest, // Button background color
                    ),
                  ),
                )
              : ThemeData.light().copyWith(
                  colorScheme: const ColorScheme.light(
                    primary: TrackSyncColors.highlightDarkest, // Header background color
                    onPrimary: TrackSyncColors.lightLightest, // Header text color
      ...
      children: [
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: IconButton(
              icon: Icon(
                ...
                color: widget.disabled ? Theme.of(context).disabledColor : Theme.of(context).dividerColor,
              ),
              onPressed: () => _selectTime(context),
            ),
            focusedBorder: OutlineInputBorder(
              borderSide: const BorderSide(color: TrackSyncColors.highlightDarkest, width: 1.5),
              borderRadius: BorderRadius.circular(12.0),
            ),
        ...
        if (widget.supportText != null)
          Padding(
            ...
            child: Text(widget.supportText!, style: TrackSyncTextStyles.bodyS()),
          ),
      ],
    );
  }
